...
<qgis version="2.18.28" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="source_1">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="operator_w">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{0ec2b25b-257b-419a-8657-43391f7d5f44}">
      <rule filter="&quot;barrier&quot; = 'fence'" key="{848faf40-9d40-4667-9ea7-4912f8c72fd2}" symbol="0" label="fence"/>
    </rules>
    <symbols>
  ...
  <aliases>
    ...
    <alias field="operator" index="3" name=""/>
    <alias field="name_en" index="4" name=""/>
    <alias field="name" index="5" name=""/>
    <alias field="barrier" index="6" name=""/>
    <alias field="wikidata" index="7" name=""/>
    <alias field="source_1" index="8" name=""/>
    <alias field="operator_w" index="9" name=""/>
    <alias field="start_date" index="10" name=""/>
    <alias field="horse" index="11" name=""/>
    <alias field="bicycle" index="12" name=""/>
    <alias field="motorcycle" index="13" name=""/>
    <alias field="motorcar" index="14" name=""/>
    <alias field="foot" index="15" name=""/>
    <alias field="highway" index="16" name=""/>
    <alias field="CLC_id" index="17" name=""/>
    <alias field="CLC_year" index="18" name=""/>
    <alias field="ref" index="19" name=""/>
    <alias field="alt_name" index="20" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="144" hidden="0" type="field" name="name_en"/>
      <column width="228" hidden="0" type="field" name="name"/>
      <column width="-1" hidden="0" type="field" name="barrier"/>
      <column width="-1" hidden="0" type="field" name="wikidata"/>
      <column width="-1" hidden="0" type="field" name="source_1"/>
      <column width="-1" hidden="0" type="field" name="operator_w"/>
      ...
      <column width="-1" hidden="0" type="field" name="CLC_id"/>
      <column width="-1" hidden="0" type="field" name="CLC_year"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="wikidata" expression=""/>
    <default field="source_1" expression=""/>
    <default field="operator_w" expression=""/>
    <default field="start_date" expression=""/>
    <default field="horse" expression=""/>
    <default field="bicycle" expression=""/>
    <default field="motorcycle" expression=""/>
    <default field="motorcar" expression=""/>
    <default field="foot" expression=""/>
    <default field="highway" expression=""/>
    <default field="CLC_id" expression=""/>
    <default field="CLC_year" expression=""/>
    <default field="ref" expression=""/>
    <default field="alt_name" expression=""/>
  </defaults>
  <previewExpression>COALESCE( "name_en", '&lt;NULL>' )</previewExpression>
